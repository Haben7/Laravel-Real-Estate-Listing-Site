        ...
        <aside class="bg-indigo-900 text-gray-100 w-64 shadow h-screen fixed top-0 left-0">
            ...
            <div class="p-4" id="div">
                <ul class="mt-4 space-y-2">
                    ...
                    <li id="li"><a href="/admin/dashboard" class="block px-4 py-2 rounded hover:bg-indigo-600 p-4"><i class="fas fa-credit-card"></i> Manage Subscription</a></li>
                    <li id="li"><a href="/admin/reports" class="block px-4 py-2 rounded hover:bg-indigo-600 p-4"><i class="fas fa-envelope"></i> Inquries Management</a></li>
            ...
            <div id="owner" class="bg-indigo-600 ">Welcome,
            </div>
        </aside>
