...
<div class="container">
    ...
    <a href="{{ route('admin.properties.housecreate', $site->id) }}" style="display: block; text-align: center; color: white; padding: 10px 15px; border-radius: 5px; text-decoration: none; margin: 20px auto; width: 150px; transition: background-color 0.3s; font-size: 1em; margin-left: 10px;" class="bg-indigo-900">Add House</a>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between" style="margin: 10px">
                            ...
                            <a href="{{ route('admin.properties.houseedit', [$house->site_id, $house->id]) }}" class="btn btn-warning">Edit</a>
                            <form action="{{ route('admin.properties.destroy', [$house->site_id, $house->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
